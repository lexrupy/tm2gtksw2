  ...
  def setup_mapping
    {
      ...
      'def:string'                        => ['string.literal', 'string.quoted.literal'],
      'def:special-char'                  => ['constant.character.escape', 'constant.character.escaped', 'string constant'],
      'def:number'                        => ['constant.numeric'],
      'def:floating-point'                => ['constant.numeric.floating-point'],
      'def:decimal'                       => ['constant.numeric.floating-point'],
      'def:base-n-integer'                => ['constant.numeric.integer.int32', 'constant.numeric.integer.int64'],
      'def:complex'                       => ['constant.numeric'],
      ...
      'def:keyword'                       => ['keyword.control', 'storage'],
      ...
      'ruby:constant'                     => ['variable.other.constant'],
      ...
      'rubyonrails:constant'              => ['variable.other.constant'],
